...
module.exports = {
	...
	*/
	initCardTransaction: function(amount, sessionID) {
		exec(null, null, 'EtisalatMCashierPlugin', 'cardtrans', [amount, sessionID]);
	},
	...
	*/
	initVoidTransaction: function(newSessionID, password, oldSessionID) {
		exec(null, null, 'EtisalatMCashierPlugin', 'voidtrans', [newSessionID, password, oldSessionID]);
	},
